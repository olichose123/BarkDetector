...
## Usage
Copy `Credentials.example.h` to `Credentials.h` and fill in the appropriate values for your WiFi network and server endpoints. Use Arduino IDE to flash the code to the M5 Atom Echo, using the M5Unified library.
